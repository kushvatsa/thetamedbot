...
class TCPage extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    final trans = Translations(locale: locale);
                      ...
                      children: [
                        ...
                        RichText(
                          ...
                          TextSpan(style: theme.textTheme.subtitle2, children: [
                            TextSpan(
                                text:
                                "${trans.text("tch1c1x")} “${trans.text(appName)}” "),
                            ...
                            TextSpan(
                              ...
                              recognizer: TapGestureRecognizer()
                                ..onTap = () async {
                                  return Navigator.pushNamed(context, privacyPath);
                                },
                            ),
                        ...
                        RichText(
                          ...
                          TextSpan(style: theme.textTheme.headline5, children: [
                            ...
                            TextSpan(text: " ${trans.text(appName)}."),
                          ]),
                        ),
                        SizedBox(
                          height: 8.0,
  ...
  _openEmailBox(
    ...
    final Uri params = Uri(
      ...
      path: contactEmail,
      query:
      'subject=${trans.text(subject).toUpperCase()}&body=[${trans.text(appName).toUpperCase()} - ${appVersion.toUpperCase()} - ${osName.toUpperCase()}] ${trans.text("dnd").toUpperCase()} ', //add subject and body here
    );
